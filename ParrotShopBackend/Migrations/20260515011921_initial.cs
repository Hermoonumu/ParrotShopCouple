        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraitsId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ParrotId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    Talkativeness = table.Column<int>(type: "integer", nullable: true),
                    ChewingRisk = table.Column<int>(type: "integer", nullable: true),
                    CareComplexity = table.Column<int>(type: "integer", nullable: true),
                    KidSafety = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Traits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Traits_Items_ParrotId",
                        column: x => x.ParrotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Items_LinkedItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_LinkedItemId",
                table: "OrderItems",
                column: "LinkedItemId");
